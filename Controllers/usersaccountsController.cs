...
namespace WebApplication1.Controllers
{
    public class usersaccountsController : Controller
    {
        ...
        public usersaccountsController(WebApplication1Context context)
        {
            _context = context;
        }
        ...
        {
            SqlConnection conn1 = new SqlConnection("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\USER\\Documents\\newdatabase.mdf;Integrated Security=True;Connect Timeout=30");
            string sql;
